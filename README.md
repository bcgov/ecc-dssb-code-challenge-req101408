# ecc-dssb-code-challenge-req101408

## Instructions for IS-21 Full Stack Developer Position
...
[FIRST_NAME]-[LAST_NAME]-ecc-dssb-IS21-code-challenge-req101408
...
Please send the final copy of your solution via a link to your repository in an email to chris.ditcher@gov.bc.ca and include ecc-dssb-code-challenge-req101408 in the subject line.
...
As Alan, I want to be able to add a product to the list of products that ECC is developing or maintaining.  
...
### BONUS User Story Three

As Alan, I want to be able to edit product related information so that I can ensure that product data is accurate.
